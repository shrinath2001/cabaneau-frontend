  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-start md:justify-center text-white text-center px-6 md:px-4 z-10 mt-[200px] md:mt-0 pt-6 md:pt-0">
        <p className="font-jost font-normal text-[14px] md:text-[21px] uppercase mb-0 md:mb-4" style={{ letterSpacing: '0.15px' }}>{tHome('hero.subtitle', 'Luxury Cabines with Private Wellness')}</p>

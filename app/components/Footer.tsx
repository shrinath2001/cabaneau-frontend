      ...
      <div className="max-w-[1920px] mx-auto px-4 md:px-8 lg:px-20 py-8 md:py-12">
        ...
        <div className="md:hidden">
          ...
          <div className="grid grid-cols-2 gap-6 mb-6">
            <div>
              <h3 className="font-jost font-medium text-[18px] mb-4 text-white">Our Cabins</h3>
              <ul className="space-y-2 font-raleway text-[13px] text-gray-100">
                <li><Link href="/cabins/1" className="hover:text-white transition">Cabin1</Link></li>
                <li><Link href="/cabins/2" className="hover:text-white transition">Cabin2</Link></li>
                <li><Link href="/cabins/3" className="hover:text-white transition">Cabin3</Link></li>
                <li><Link href="/cabins/4" className="hover:text-white transition">Cabin4</Link></li>
                <li><Link href="/cabins/5" className="hover:text-white transition">Cabin5</Link></li>
                <li><Link href="/cabins/6" className="hover:text-white transition">Cabin6</Link></li>
              </ul>
            </div>

            <div>
              <h3 className="font-jost font-medium text-[18px] mb-4 text-white">Region & Services</h3>
              <ul className="space-y-2 font-raleway text-[13px] text-gray-100">
            ...
            <div>
              <h3 className="font-jost font-medium text-[18px] mb-4 text-white">SEO Links</h3>
              <ul className="space-y-2 font-raleway text-[13px] text-gray-100">
            ...
            <div>
              <h3 className="font-jost font-medium text-[18px] mb-4 text-white">Contact Us</h3>
              <ul className="space-y-3 font-ralaway text-[13px] text-gray-100">
                <li className="flex items-start gap-2">
                  ...
                  <a href="tel:+32497556009" className="hover:text-white transition">(+32)897-556-009</a>
                </li>
                <li className="flex items-start gap-2">
                  <svg className="w-4 h-4 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                ...
                <li className="flex items-start gap-2">
                  ...
                  <span>Selterschlag 19A, 4700<br/>Eupen - Belgium</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="hidden md:flex justify-between items-start mb-12">
          ...
          <div className="w-[180px] flex-shrink-0">
            <Image src="/assets/Group 1.png" alt="Cabanéau Logo" width={150} height={25} className="w-auto h-auto mb-3" />
          ...
          <div className="flex gap-12 lg:gap-16 xl:gap-20">
            {/* Column 1: Our Cabins */}
            <div>
              <h3 className="font-jost font-medium text-[16px] mb-3 text-white">Our Cabins</h3>
            ...
            <div>
              <h3 className="font-jost font-medium text-[16px] mb-3 text-white">Region & Services</h3>
              <ul className="space-y-1.5 font-raleway text-[13px] text-gray-100">
                <li><Link href="/services/food" className="hover:text-white transition">Food & Drink Service</Link></li>
                <li><Link href="/activities" className="hover:text-white transition">Activities</Link></li>
                <li><Link href="/services/massage" className="hover:text-white transition">Massage</Link></li>
            ...
            {/* Column 3: SEO Links */}
            <div>
              <h3 className="font-jost font-medium text-[16px] mb-3 text-white">SEO Links</h3>
              <ul className="space-y-1.5 font-raleway text-[13px] text-gray-100">
                <li><Link href="/food-drinks" className="hover:text-white transition">Food & Drinks</Link></li>
                <li><Link href="/massage" className="hover:text-white transition">Massage</Link></li>
              </ul>
            ...
            {/* Column 4: Contact Us */}
            <div>
              <h3 className="font-jost font-medium text-[16px] mb-3 text-white">Contact Us</h3>
              <ul className="space-y-2 font-raleway text-[13px] text-gray-100">
                <li className="flex items-start gap-2">
                  <svg className="w-3.5 h-3.5 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                  </svg>
                  <a href="tel:+32897556009" className="hover:text-white transition">(+32)897-556-009</a>
                </li>
                <li className="flex items-start gap-2">
                  <svg className="w-3.5 h-3.5 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" />
                ...
                <li className="flex items-start gap-2">
                  ...
                  <span className="leading-[1.4]">Selterschlag 19A, 4700<br/>Eupen - Belgium</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="pt-6 border-t border-gray-700">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            {/* Copyright */}
            <p className="text-[13px] font-raleway text-gray-100">Copyright 2025</p>
            ...
            <div className="flex items-center gap-3">
              <a href="#" aria-label="Facebook" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-md bg-white flex items-center justify-center hover:bg-gray-200 transition">
                <svg className="w-4 h-4 text-gray-800" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </a>
              <a href="#" aria-label="Instagram" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-md bg-white flex items-center justify-center hover:bg-gray-200 transition">
                <svg className="w-4 h-4 text-gray-800" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="#" aria-label="YouTube" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-md bg-white flex items-center justify-center hover:bg-gray-200 transition">
                <svg className="w-4 h-4 text-gray-800" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
                </svg>
              </a>
              <a href="#" aria-label="TikTok" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-md bg-white flex items-center justify-center hover:bg-gray-200 transition">
                <svg className="w-4 h-4 text-gray-800" fill="currentColor" viewBox="0 0 24 24">

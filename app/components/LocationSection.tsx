...
const LocationSection = () => {
  ...
  return (
    <section className="bg-white py-6 md:py-5 px-4 md:px-20 md:mt-12">
      <div className="container mx-auto ">
        <div className="max-w-[1390px] mx-auto">
          <h2 className="font-logga text-[28px] md:text-[42px] font-semibold text-center mb-8 md:mb-16">{t('location_section.title', 'WHERE WE ARE')}</h2>
